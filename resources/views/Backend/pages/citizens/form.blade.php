...
<div class="form-group">
        ...
        <div class="form-group">
            ...
            <input required name="phone_number" type="number" class="form-control" id="name" placeholder="contact number">
        ...
        <div class="form-group">
            ...
            <input required name="registration_number" type="number" class="form-control" id="name" placeholder="contact number">
